...
const AddHabitForm = ({ ToggleForm, AddHabit }) => {
  ...
  return (
    <form
      ...
      id='addHabitForm'
      className='absolute top-32 w-3/6 mx-auto inset-x-0 bg-white border shadow-md rounded-lg p-4 hidden'
    >
      <div className='mb-4'>
        <label
        ...
        <div className='mb-4 flex justify-center gap-7'>
          ...
          <div className='flex'>
            <input
              ...
              onChange={handleHabitChange}
            />
            <label htmlFor='blue' className='text-lg text-blue-400 font-bold'>
              Blue
            </label>
          </div>
          {/* Green Radio Button */}
          <div className='flex'>
            <input
              ...
              onChange={handleHabitChange}
            />
            <label htmlFor='green' className='text-lg text-green-400 font-bold'>
              Green
            </label>
          </div>
        </div>
